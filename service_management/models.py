...
class Participation(Model):
    ...
    resource_position = ForeignKey(ResourcePosition, on_delete=models.CASCADE, null=True)
    accepted = BooleanField(default=False)

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["user", "shift"], name="unique_shift_participation")
        ]

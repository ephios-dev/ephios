...
# PACKAGE_DIR is the directory containing this settings.py file, which is usually src/ephios
...
CORE_PLUGINS = [
    ...
    "ephios.plugins.questionnaires.apps.PluginApp",
]
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(PACKAGE_DIR, "templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOCALE_PATHS = [os.path.join(PACKAGE_DIR, "locale")]

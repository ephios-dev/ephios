...
Generally, ephios can be installed like most django projects. We plan on providing a docker image in the future.

Manual installation
~~~~~~~~~~~~~~~~~~~

To run ephios on a debian-based system, make sure you have installed the prerequisites mentioned above.

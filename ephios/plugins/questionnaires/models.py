...
class Question(models.Model):
    ...
    def get_pk_from_slug(slug: str):
        """
        Returns the questions' pk from a formfield slug  generated by `Question.get_form_slug`.
        These slugs have the format `123-demo-question`.

        When added to the form, they're prefixed with the plugin name, resulting in `questionnaires.123-demo-question`.

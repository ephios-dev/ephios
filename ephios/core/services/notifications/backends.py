...
class EmailNotificationBackend(AbstractNotificationBackend):
    ...
    def send(cls, notification):
        ...
        # TODO what happens if sending this particular mail sending fails?
        # should we retry? How often? How do we keep track?
        # Should we mark the notification as failed?
        # It should definitely not cause other notifications of the batch to fail.

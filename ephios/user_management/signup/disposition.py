...
from ephios.user_management.models import AbstractParticipation, Shift, UserProfile


class BaseDispositionParticipationForm(forms.ModelForm):
    disposition_participation_template = "user_management/disposition/fragment_participation.html"
...
class DispositionView(DispositionBaseViewMixin, TemplateView):
    template_name = "user_management/disposition/disposition.html"

...
from ephios.user_management.models import AbstractParticipation, LocalParticipation, UserProfile
...
def new_event(event):
    ...
    html_content = render_to_string(
        "user_management/mails/new_event.html", {"event": event, "site_url": SITE_URL}
    )

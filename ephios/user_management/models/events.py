...
if TYPE_CHECKING:
    ...
    from ephios.user_management.signup import AbstractParticipant
...
class Event(Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse("user_management:event_detail", args=[str(self.id)])
...
class Shift(Model):
    ...
    def signup_method(self):
        from ephios.user_management.signup import signup_method_from_slug
...
class LocalParticipation(AbstractParticipation):
    ...
    def save(self, *args, **kwargs):
        ...
        if (
            not self.user.has_perm("user_management.view_event", obj=self.shift.event)
            ...
            assign_perm("user_management.view_event", user_or_group=self.user, obj=self.shift.event)
...
class EventTypePreference(PerInstancePreferenceModel):
    ...
    class Meta:
        ...
        app_label = (
            "user_management"  # https://github.com/agateblue/django-dynamic-preferences/issues/96
        )
